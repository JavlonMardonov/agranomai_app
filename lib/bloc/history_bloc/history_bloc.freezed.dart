...
abstract class FetchHistory implements HistoryEvent {
  const factory FetchHistory() = _$FetchHistoryImpl;
}
...
mixin _$HistoryState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Datum> history) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Datum> history)? loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<Datum> history) : _history = history;

  final List<Datum> _history;
  @override
  List<Datum> get history {
...
abstract class _Loaded implements HistoryState {
  const factory _Loaded(final List<Datum> history) = _$LoadedImpl;
